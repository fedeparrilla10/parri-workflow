...
Never infer a glossary from a broad codebase scan. Code can confirm or contradict a proposed definition, but code alone does not establish product meaning.
